    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_link', models.CharField(choices=[('tp', 'https://t.me/test_2_dedalus_bot'), ('sh', 'https://google.com')], default='tp', help_text='Выбрать ссылку для перехода пользователя, после нажатия на клавишу "согласен"', max_length=255, verbose_name='Ссылка на тп/магазин')),
